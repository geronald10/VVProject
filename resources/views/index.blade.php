        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" data-toggle="modal" data-target="#myModal">About</a>
                    </li>
                    <li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h1 class="brand-heading">VV</h1>
                        <p class="intro-text">A smart personal assistant.</p>
                        <p> find what you're searching with ease</p>
                        <a class="btn btn-circle page-scroll" data-toggle="modal" data-target="#myModal">
